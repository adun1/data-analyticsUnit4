...
#### There is substantial evidence that the pokémon HP data is normally distributed. The four main supporting arguments suggesting that this data follows a normal distribution are arguments __1.1__, __1.2__, __1.3__, and __1.4__.
### 1.1 - Histogram of HP
...
#### This dotplot shows that some Pokémon types are more numerous than others. For instance Bug Pokémon is numerous as the dots (cards) are distributed in a normal fashion. In contrast, there are few flying Pokémon. Therefore, there will be more variation in the flying Pokémon due to a smaller dataset. Overall most pokemon types follow a normal distribution.
```{r}
